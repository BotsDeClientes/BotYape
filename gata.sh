...
if wget -q https://github.com/YallicoOwner/Final/raw/master/musicSH/"$random_mp3"; then
...
echo -e "\033[1;35m"
git clone https://github.com/YallicoOwner/Final.git
...
echo -e "\033[01;32m\033[01mIniciando Final!!\nStarting CatBot!!\n\033[0m"
npm start
