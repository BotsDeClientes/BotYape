...
mobile: MethodMobile, 
browser: opcion == '1' ? ['Miku-Bot-MD', 'Edge', '2.0.0'] : methodCodeQR ? ['Miku-Bot-MD', 'Edge', '2.0.0'] : ['Chrome (Linux)', '', ''],
auth: {
creds: state.creds,
...
const DSBPreKeys = readdirSync(`./Yallico/${directorio}`).filter(fileInDir => {
...
const directories = ['./YallicoSession/', './Yallico/']
